...
import umg.ingenieriadesoftware.app.models.entity.Cliente;
import umg.ingenieriadesoftware.app.models.entity.Factura;
import umg.ingenieriadesoftware.app.models.entity.ItemFactura;
import umg.ingenieriadesoftware.app.models.entity.Producto;
import umg.ingenieriadesoftware.app.models.service.IClienteService;
import umg.ingenieriadesoftware.app.models.service.IProductoService;
...
public class FacturaController {
	...
	public String guardar(@Valid Factura factura, BindingResult result, Model model,
		...
		for (int i = 0; i < itemId.length; i++) {
			...
			Producto productoTemp = productoService.findOne(producto.getId());
			Integer cantidadDeProductoTemporal = productoTemp.getCantidadDisponibe();

			if (cantidadDeProductoTemporal >= cantidad[i]) {
				linea.setCantidad(cantidad[i]);
				linea.setProducto(producto);
				productoTemp.setCantidadDisponibe(cantidadDeProductoTemporal - cantidad[i]);
				...
				model.addAttribute("error",
						messageSource.getMessage("text.factura.flash.lineas.errorCantidad", null, locale));
				return "factura/form";
			}
